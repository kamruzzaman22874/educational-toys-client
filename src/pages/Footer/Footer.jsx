...
const Footer = () => {
    return (
        <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-20 my-20">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-42 h-16" src={logo} alt="" />

                        <p className="text-base leading-relaxed text-gray-600 mt-7">Exploring the world of learning through play, Educational Toys offers a curated selection of fun and enriching tools fostering creativity and skill development for young minds.</p>
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        ...
                        <form action="#" method="POST" className="mt-6">
                            ...
                            <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-[#3ec5c7] rounded-md hover:bg-blue-700 focus:bg-blue-700">Subscribe</button>
                        </form>
                    </div>
                </div>
                ...
                <p className="text-sm text-center text-gray-600">© Copyright 2023, All Rights Reserved by Educational Toys</p>
            </div>
        </section>
