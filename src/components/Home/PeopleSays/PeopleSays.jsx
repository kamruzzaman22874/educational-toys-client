...
import people2 from "../../../assets/image/people2.webp"
import people3 from "../../../assets/image/people3.webp"
import SectionTitle from "../../SectionTitle/SectionTitle";
// import people4 from "../../../assets/image/people4.webp"
            ...
            <section className="py-10 bg-gray-100 sm:py-16 lg:py-24 ">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <SectionTitle
                        ...
                        heading="They speak their heart out"
                    ></SectionTitle>
                    <div className="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
                        <div className="overflow-hidden bg-white rounded-md shadow">
                            <div className="px-8 py-12">
                                <div className="relative w-24 h-24 mx-auto">
                                    <img className="relative object-cover w-24 h-24 mx-auto rounded-full" src={people1} alt="" />
                                ...
                                <blockquote className="mt-7">
                                    <p className="text-lg text-black">“I love to visit KinderLand Kids Fashion Store to anyone with a kid. They simply have amazing things we need day to day...”</p>
                                </blockquote>
                        ...
                        <div className="overflow-hidden bg-white rounded-md shadow">
                            <div className="px-8 py-12">
                                <div className="relative w-24 h-24 mx-auto">
                                    <img className="relative object-cover w-24 h-24 mx-auto rounded-full" src={people2} alt="" />
                                    <div className="absolute top-0 right-0 flex items-center justify-center bg-blue-600 rounded-full w-7 h-7">
                                        <svg className="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                            <path
                                                d="M20.309 17.708C22.196 15.66 22.006 13.03 22 13V5a1 1 0 0 0-1-1h-6c-1.103 0-2 .897-2 2v7a1 1 0 0 0 1 1h3.078a2.89 2.89 0 0 1-.429 1.396c-.508.801-1.465 1.348-2.846 1.624l-.803.16V20h1c2.783 0 4.906-.771 6.309-2.292zm-11.007 0C11.19 15.66 10.999 13.03 10.993 13V5a1 1 0 0 0-1-1h-6c-1.103 0-2 .897-2 2v7a1 1 0 0 0 1 1h3.078a2.89 2.89 0 0 1-.429 1.396c-.508.801-1.465 1.348-2.846 1.624l-.803.16V20h1c2.783 0 4.906-.771 6.309-2.292z"
                                ...
                                <blockquote className="mt-7">
                                    <p className="text-lg text-black">“Our kids loves KinderLand Kids Fashion Store because they can keep playing while we do the shopping to our heart's content and their's!”</p>
                                </blockquote>
                        ...
                        <div className="overflow-hidden bg-white rounded-md shadow">
                            <div className="px-8 py-12">
                                <div className="relative w-24 h-24 mx-auto">
                                    <img className="relative object-cover w-24 h-24 mx-auto rounded-full" src={people3} alt="" />
                                    <div className="absolute top-0 right-0 flex items-center justify-center bg-blue-600 rounded-full w-7 h-7">
                                        <svg className="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                            <path
                                                d="M20.309 17.708C22.196 15.66 22.006 13.03 22 13V5a1 1 0 0 0-1-1h-6c-1.103 0-2 .897-2 2v7a1 1 0 0 0 1 1h3.078a2.89 2.89 0 0 1-.429 1.396c-.508.801-1.465 1.348-2.846 1.624l-.803.16V20h1c2.783 0 4.906-.771 6.309-2.292zm-11.007 0C11.19 15.66 10.999 13.03 10.993 13V5a1 1 0 0 0-1-1h-6c-1.103 0-2 .897-2 2v7a1 1 0 0 0 1 1h3.078a2.89 2.89 0 0 1-.429 1.396c-.508.801-1.465 1.348-2.846 1.624l-.803.16V20h1c2.783 0 4.906-.771 6.309-2.292z"
                                ...
                                <blockquote className="mt-7">
                                    <p className="text-lg text-black">“We like the fact KinderLand Kids Fashion Store is very close to the playground. The kids just love the atmosphere at KinderLand Kids Fashion Store....!”</p>
                                </blockquote>
