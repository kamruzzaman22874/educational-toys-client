    ...
    return (
        <section className="py-10 bg-gradient-to-r from-bg-[#3ec5c7] to-blue-600 sm:py-16 lg:py-8">
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                ...
                <SectionTitle
                    heading="You can contact with us"
                    subHeading="Contact"
                ></SectionTitle>
                            ...
                            <div className="p-6 sm:p-10">
                                ...
                                <form ref={form} onSubmit={sendEmail} action="#" method="POST" className="mt-8">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                        ...
                                        <div className="sm:col-span-2">
                                            <button type="submit" className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-[#3ec5c7] border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">
                                                Send
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-8 space-y-7">
                                            <div className="flex items-start">
                                                <svg className="flex-shrink-0 text-[#3ec5c7] w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                                </svg>
                                                <span className="block ml-3 text-base text-gray-900"> 57/56, Alawal Avenue, Uttara, Dhaka-1230, Bangladesh </span>
                                            </div>
                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <span className="block ml-3 text-base text-gray-900"> hossen2022jamal@gmail.com </span>
                                            </div>
                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <div className="ml-3">
                                                    <span className="block text-base text-gray-900"> +88 01989 21 47 21 </span>
                                                    <span className="block mt-1 text-base text-gray-900"> +88 01726 222 874 </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
